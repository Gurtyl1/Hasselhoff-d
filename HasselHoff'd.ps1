...
$image =  "https://github.com/Gurtyl1/Hasselhoff-d/blob/main/HHoff2.png"

$i = -join($image,"?dl=1")
iwr $i -O $env:TMP\i.png

iwr https://raw.githubusercontent.com/Gurtyl1/Hasselhoff-d/main/HHoff2.png -O $env:TMP\i.png

# Download WAV file; replace link to $wav to add your own sound

$wav = "https://github.com/Gurtyl1/Hasselhoff-d/blob/main/Baywatch.wav?raw=true"
...
$o=New-Object -ComObject WScript.Shell
    ...
    while (1) {
        ...
        if ([Windows.Forms.Cursor]::Position.X -ne $originalPOS){
            ...
            $o.SendKeys("{ENTER}");Start-Sleep -Seconds $pauseTime
        }
    }
}
